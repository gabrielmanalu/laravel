            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select name="blog_category_id"class="form-select" aria-label="Default select example">
                                ...
                                <option value="{{ $item->id }}" {{ $item->id == $blog->blog_category_id
                                ? 'selected' : ''}}>{{ $item->blog_category }}</option>
                                @endforeach
                    ...
                    <div class="row mb-2">
                        ...
                        <input type="submit" class="btn btn-success waves-effect waves-light" value="Edit Blog Data">
                    </form><!-- end row -->
                </div>
            </div>
        </div> <!-- end col -->
